...
class TestEstimates(TestCase):
    ...
    @patch('src.routes.deliveries.Estimates.get_mongo')
    @patch('src.routes.deliveries.Estimates.get_firebase')
    def test_post_ok(self, mock_get_firebase, mock_get_mongo, mock_requests):
        ...
        response = self.app.get('/products/5c06f868556f89598152f2eb/deliveries/estimate')
