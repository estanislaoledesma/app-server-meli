...
from src.routes import hello, user, products, product, purchase
...
api.add_resource(purchase.Purchase, '/products/<product_id>/purchases', resource_class_kwargs={'logger': app.logger, 'firebase': firebase, 'mongo': mongo})
